...
- в силу ограниченного предназначения в MSP не реализованы:
  ...
  - управление версиями (выпусками), требованиями, коммуникациями, проектной структурой (с определением ролей и полномочий участников проекта), запросами на изменения, рисками (риски есть в онлайн-версиях).
